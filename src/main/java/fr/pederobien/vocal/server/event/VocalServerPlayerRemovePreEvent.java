...
public class VocalServerPlayerRemovePreEvent extends VocalServerPlayerListEvent implements ICancellable {
	 ...
	 */
	public VocalServerPlayerRemovePreEvent(IServerPlayerList list, IVocalPlayer player) {
		super(list);
		this.player = player;
	}
