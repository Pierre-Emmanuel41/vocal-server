...
public class VocalServerPlayerRemovePostEvent extends VocalServerPlayerListEvent {
	 ...
	 */
	public VocalServerPlayerRemovePostEvent(IServerPlayerList list, IVocalPlayer player) {
		super(list);
		this.player = player;
	}
