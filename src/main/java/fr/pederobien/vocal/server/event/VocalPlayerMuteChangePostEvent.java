...
public class VocalPlayerMuteChangePostEvent extends VocalPlayerEvent implements ICancellable {
	 ...
	 */
	public VocalPlayerMuteChangePostEvent(IVocalPlayer player, boolean oldMute) {
		super(player);
